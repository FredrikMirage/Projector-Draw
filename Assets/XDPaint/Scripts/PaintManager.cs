...
namespace XDPaint
{
    public class PaintManager : MonoBehaviour, IPaintManager
    {
        ...
        {
            if (initialized && ComponentType == ObjectComponentType.SpriteRenderer)
            {
        ...
        public bool IsLayersContainerExists(string filename)
        {
            ...
            return filename.IsCorrectFilename(true) && File.Exists(path);
        }
        ...
        private void InitRenderTextures()
        {
            ...
            renderTextureHelper.Init(new Vector2Int(Material.SourceTexture.width, Material.SourceTexture.height), filterMode, Material.SourceTextureWrapMode);
